...
@section('title')
    @lang('_page_titles.Admin') | Create Coupon
@endsection
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="breadcrumb-holder">
                    <h1 class="main-title float-left">Create Coupon</h1>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-header">
                        <h3><i class="fa fa-file-o"></i> Create Coupon </h3>
                        New coupon code can be created from here.
                    </div>
