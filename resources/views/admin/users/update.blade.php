            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.manage.user.edit', ['id' => $user->id]) }}"
                                    ...
                                    <div class="form-row">
                                            ...
                                            <select id="country"
                                                ...
                                                @foreach($countries as $country)
                                                    <option value="{{ $country->id }}"
                                                            @if(old('country', $user->country) == $country->id) selected="selected" @endif>{{ $country->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select id="legal_status"
                                                ...
                                                <option value="1"
                                                        @if(old('legal_status',$user->legal_status) == '1') selected="selected" @endif>
                                                    Legal
                                                </option>
                                                <option value="0"
                                                        @if(old('legal_status',$user->legal_status) == '0') selected="selected" @endif>
                                                    Illegal
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select id="applicable_gaap"
                                                ...
                                                <option value="Ministry Of Corporate Affairs (MCA)"
                                                        @if(old('applicable_gaap',$user->applicable_gaap == "Ministry Of Corporate Affairs (MCA)")) selected="selected" @endif>
                                            ...
                                            <select id="industry_type"
                                                ...
                                                @foreach($industry_types as $type)
                                                    <option value="{{ $type->id }}"
                                                            @if(old('industry_type',$user->industry_type) == $type->id) selected="selected" @endif>{{ $type->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="annual_reporting_period" type="text"
                                                   ...
                                                   value="{{ old('annual_reporting_period',$user->annual_reporting_period) }}"
                                                   autocomplete="off">
