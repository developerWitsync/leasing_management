...
@section('title')
    @lang('_page_titles.Admin') | @lang('_page_titles.Dashboard')
@endsection
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="breadcrumb-holder">
                <h1 class="main-title float-left">@lang('_sidebar.Dashboard')</h1>
                <ol class="breadcrumb float-right">
                    <li class="breadcrumb-item">@lang('_sidebar.Home')</li>
                    <li class="breadcrumb-item active">@lang('_sidebar.Dashboard')</li>
                </ol>
