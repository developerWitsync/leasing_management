 <div class="itemTab" >
                            <ul>
                                <li class="@if(request()->segment(2) == 'lessor-details') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'underlying-lease-assets') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'fair-market-value') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'residual-value-gurantee') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'lease-termination-option') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'lease-renewal-option') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'purchase-option') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'lease-duration-classified') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'escalation') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'select-low-value') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'select-discount-rate') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'lease-balnce-as-on-dec') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'initial-direct-cost') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'lease-incentives') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'lease-valuation') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'lease-payment-invoice') active @endif">
                                    <a href="#">
                                ...
                                <li class="@if(request()->segment(2) == 'review-submit') active @endif">
                                    <a href="#">
