        ...
        <ul class="list-inline float-right mb-0">
            ...
            <li class="list-inline-item dropdown notif">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    <!-- item-->
                    <div class="dropdown-item noti-title">
                        <h5 class="text-overflow"><small>@lang('_sidebar.Hello'), {{ ucwords(Auth::guard('admin')->user()->first_name. " ". Auth::guard('admin')->user()->last_name) }}</small> </h5>
                    </div>
                    ...
                    <a href="{{ route('admin.auth.logout') }}" class="dropdown-item notify-item">
                        <i class="fa fa-power-off"></i> <span>@lang('_sidebar.Logout')</span>
                    </a>
