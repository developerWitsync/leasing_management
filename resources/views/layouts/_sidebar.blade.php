...
<a href="#" class="list-group-item"><i class="fa fa-envelope-square"></i> <span>Drafts Saved</span>
<small class="fa fa-angle-right" aria-hidden="true"></small>
</a>
<a href="#" class="list-group-item"><i class="fa fa-pencil-square"></i> <span>Modify Lease</span>
<small class="fa fa-angle-right" aria-hidden="true"></small>
</a>
<a href="#" class="list-group-item"><i class="fa fa-dollar"></i> <span>Lease Valuation</span>
<small class="fa fa-angle-right" aria-hidden="true"></small>
</a>
