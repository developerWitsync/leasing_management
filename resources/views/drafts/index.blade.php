                ...
                "columnDefs": [
                    {
                        ...
                        "render": function (data, type, full, meta) {
                            var html = "<button  data-toggle='tooltip' data-placement='top' title='Edit Lease Details' type=\"button\" data-lease_id='" + full['id'] + "' class=\"btn btn-sm  btn-success edit_lease_detail\"><i class=\"fa fa-pencil-square-o fa-lg\"></i></button>";
                            if(full['can_be_deleted']){
                                html += "<button  data-toggle='tooltip' data-placement='top' title='Delete Lease Details' type=\"button\" data-lease_id='" + full['id'] + "' class=\"btn btn-sm btn-danger delete_lease_detail\"><i class=\"fa fa-trash-o\"></i></button>";
                            }
                            return html;
            ...
            $(document.body).on('click', '.delete_lease_detail', function () {
                ...
                bootbox.confirm({
                    ...
                    callback: function (result) {
                        if (result) {
                            $.ajax({
                                url: "/drafts/delete-lease-details/" + lease_id,
                                type: 'delete',
                                dataType: 'json',
