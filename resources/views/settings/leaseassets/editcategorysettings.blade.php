            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active">
                    <div class="panel panel-info">
                        <div class="panel-heading">Update {{ $setting->category->title }} Type</div>
                        <div class="panel-body">
                            <form method="post" class="form-horizontal">
                                {{ csrf_field() }}

                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }} required">
                                    <label for="title" class="col-md-4 control-label">Enter {{ $setting->category->title }} Type</label>
                                    <div class="col-md-8">
                                        <input type="text" placeholder="Title" name="title" class="form-control" value="{{ old('title', $setting->title) }}">
                                        @if ($errors->has('title'))
