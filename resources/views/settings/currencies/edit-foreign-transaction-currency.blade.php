            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active">
                    <div class="panel panel-info">
                        <div class="panel-heading">Update Foreign Currency Transaction Settings</div>
                        <div class="panel-body">
                            <form method="post" class="form-horizontal">
                                    ...
                                    <div class="col-md-8">
                                        <select id="foreign_exchange_currency" class="form-control" name="foreign_exchange_currency">
                                            ...
                                            @foreach($currencies as $currency)
                                                <option value="{{ $currency->code }}" @if($currency->code == old('foreign_exchange_currency', $model->foreign_exchange_currency)) selected="selected" @endif>{{ $currency->code }}  {{ $currency->symbol }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group{{ $errors->has('exchange_rate') ? ' has-error' : '' }} required">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="exchange_rate" value="{{ old('exchange_rate', $model->exchange_rate) }}" name="exchange_rate" class="form-control" placeholder="Exchange">
                                ...
                                <div class="form-group{{ $errors->has('valid_from') ? ' has-error' : '' }} required">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="valid_from" value="{{ old('valid_from', date('d-M-Y', strtotime($model->valid_from))) }}" name="valid_from" class="form-control" placeholder="Exchange Rate Valid From">
                                ...
                                <div class="form-group{{ $errors->has('valid_to') ? ' has-error' : '' }} required">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" id="valid_to" value="{{ old('valid_to',date('d-M-Y', strtotime($model->valid_to))) }}" name="valid_to" class="form-control" placeholder="Exchange Rate Valid To">
