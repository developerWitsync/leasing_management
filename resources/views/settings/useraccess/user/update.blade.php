                    ...
                    <div role="tabpanel" class="tab-pane active">
                     <div class="panel panel-info">
                            ...
                            Edit User
                              ...
                              <div class="panel-body">
                             <form class="form-horizontal" method="POST" action="{{ route('settings.user.update', ['id' => $user->id]) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="col-md-6">
                                <input id="authorised_person_name" type="text" class="form-control" name="authorised_person_name" value="{{ old('authorised_person_name', $user->authorised_person_name) }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('authorised_person_dob') ? ' has-error' : '' }} required">
                            ...
                            <div class="col-md-6">
                                <input id="authorised_person_dob" type="text" class="form-control" name="authorised_person_dob" value="{{ old('authorised_person_dob', $user->authorised_person_dob) }}" autofocus>
                        ...
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }} required">
                            ...
                            <div class="col-md-6">
                                <select name="gender" class="form-control">
                                    ...
                                    <option value="1" @if("1" == old('gender', $user->gender)) selected="selected" @endif>Male</option>
                                    <option value="2" @if("2" == old('gender', $user->gender)) selected="selected" @endif>Female</option>
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('authorised_person_designation') ? ' has-error' : '' }} required">
                            ...
                            <div class="col-md-6">
                                <input id="authorised_person_designation" type="text" class="form-control" name="authorised_person_designation" value="{{ old('authorised_person_designation', $user->authorised_person_designation) }}" autofocus>
