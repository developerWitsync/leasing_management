                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="form-group{{ $errors->has('uuid') ? ' has-error' : '' }} required">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    @endphp
                                    <input id="uuid" type="text" placeholder="ULA Code" class="form-control" name="uuid" value="{{ old('ula_code', $ula_code) }}" readonly="readonly">
                                    @if ($errors->has('uuid'))
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <select name="category_id" class="form-control asset_category" @if($subsequent_modify_required) disabled="disabled" @endif>
                                        ...
                                        @foreach($lease_assets_categories as $category)
                                            <option value="{{ $category->id }}" @if(old('category_id', $asset->category_id) == $category->id) selected="selected" @endif>{{ $category->title }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group{{ $errors->has('sub_category_id') ? ' has-error' : '' }} required">
                                ...
                                <div class="col-lg-4 col-md-6">
                                            ...
                                            @foreach($lease_assets_categories as $category)
                                                @if($category->id == old('category_id', $asset->category_id))
                                                    @foreach($category->subcategories as $subcategory)
                                                        <option value="{{ $subcategory->id }}" @if($subcategory->id == old('sub_category_id', $asset->sub_category_id)) selected="selected" @endif>{{ $subcategory->title }}</option>
                                                    @endforeach
                                                @endif
                                            @endforeach
                                        @endif
                                    ...
                                    @if($subsequent_modify_required)
                                        <input type="hidden" name="sub_category_id"  value="{{ $asset->sub_category_id }}"/>
                                    @endif
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <select name="similar_asset_items" class="form-control" @if($subsequent_modify_required) disabled="disabled" @endif>
                                        ...
                                        @foreach($la_similar_charac_number as $number)
                                            <option value="{{ $number->number }}" @if($number->number == $asset->similar_asset_items) selected="selected" @endif>{{ $number->number }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    @if($subsequent_modify_required)
                                        <input type="hidden" name="similar_asset_items"  value="{{ $asset->similar_asset_items }}"/>
                                    @endif
