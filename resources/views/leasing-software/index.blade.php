...
@section('content')
                    ...
                    <div class="carousel-wrap">
                        <div class="owl-carousel one">
                            <div class="item"><a href="javascript:void(0);"><img
                                            src="{{ asset('master/images/fd1/airline.jpeg?ver=1') }}">
                                    <p>Airline</p></a></div>
                            <div class="item"><a href="javascript:void(0);"><img
                                            src="{{ asset('master/images/fd1/land.jpeg?ver=1') }}">
                                    <p>Land</p></a></div>
                            <div class="item"><a href="javascript:void(0);"><img
                                            src="{{ asset('master/images/fd1/commercial.jpeg?ver=1') }}">
                                    <p>Commercial Property</p></a></div>
                            <div class="item"><a href="javascript:void(0);"><img
                                            src="{{ asset('master/images/fd1/machinery.jpeg?ver=1') }}">
                                    <p>Plant & Machinery</p></a></div>
                            <div class="item"><a href="javascript:void(0);"><img
                                            src="{{ asset('master/images/fd1/intangibles.jpeg?ver=1') }}">
                                    <p>Intangibles</p></a></div>
                            <div class="item"><a href="javascript:void(0);"><img
                                            src="{{ asset('master/images/fd1/agricultural-assets.jpeg?ver=1') }}">
                                    <p>Agricultural Assets</p></a></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-3">
                    <div class="card img">
                        <div class="overl">
                            ...
                            <br><br><br>
                            <a href="javascript:void(0);" class="btn btn1">View More Detail <i
        ...
        <div class="container">
            ...
            <div class="row lease_30_a">
                <div class="col-sm-6">
                    ...
                    <br>
                    <p>The software is designed for lessee’s in compliance with IFRS-16 on leases. Build to streamline
                        your administrative additional workflow to enable you to easily value and manage your leases on
                        a single destination with full disclosure from lease start to lease end.</p>
                    <div><br></div>
                    <a href="javascript:void(0);" class="btn btn1" data-toggle="modal" data-target="#leasing_software">Subscribe
                        Now <i class="fa fa-angle-right"></i></a>
                    <a href="javascript:void(0);" class="btn btn2" data-toggle="modal" data-target="#leasing_software">Try
                        Now for Free<i class="fa fa-angle-right"></i></a>
                </div>
                        ...
                        <div class="owl-carousel two">
                                    ...
                                    <div class="card">
                                        <div class="cnt">
                                            ...
                                            <p class="">He is a qualified Chartered Accountant from India with over 13
                                                years of practical professional experience in almost all fields of
                                                integrated finance – IFRS’s, Accounting, Auditing, Taxation, Valuations,
                                                Cost & Benefit Analysis etc. He understands the transitional &
                                                subsequent challenges in the process of lease valuations and to simply
                                                the processes he invested over 9 months in the development of the
                                                leasing software duly compliant with principles as set in IFRS 16 to
                                                make an effective and easy tool for companies and its users. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {{--<div class="item">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12 wow fadeInDown">
                                    <div class="card">
                                        <div class="cnt">
                                            <h2>Shahnawaz Khan <br>
                                                <small>Chartered Accountant</small>
                                            </h2>
                                            <p>He is a Chartered Accountant from ICAI and ICAEW with over 18 years of
                                                professional experience specializing in financial services, Statutory
                                                Audits, Due Diligence, Compliance, and Regulatory Reviews and
                                                facilitated the number of training on IFRSs, insurance, and banking. He
                                                works as a partner with Grant Thornton. He reviewed in his individual
                                                capacity all key features of the WISTYNC's Leasing Software and provided
                                                his valuable inputs based on industry trends and best practices.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>--}}
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12 wow fadeInDown">
                                    <div class="card">
                                        <div class="cnt">
                                            ...
                                            <p>He holds Post Graduate Diploma in Management (Specialized in Finance) and
                                                possess over 6 years of practical experience in finance. He has actively
                                                supported in the research and analysis of the key elements in IFRS 16
                                                and has done the extensive review of the basic functions of Leasing
                                                software. He is also part of the WITSYNC in assisting clients (GCC and
                                                Asia Pacific) with accounting, auditing and taxation assignments.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            {{--<div class="item">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12 wow fadeInDown">
                                    <div class="card">
                                        <div class="cnt">
                                            <h2>Sajeev Surendran <br>
                                                <small>Independent External Reviewer</small>
                                            </h2>
                                            <p>He is a Chartered Accountant from ICAI and a Certified Management
                                                Accountant with over 15 years of professional experience specializing in
                                                financial and management consulting services. His expertise includes
                                                IFRS, Accounting, Forensic and Special Audits, Taxation and internal
                                                controls including process re-engineering. He is working as Managing
                                                Partner at Finpro Consulting, Sultanate of Oman. He independently
                                                reviewed the WISTYNC's Leasing Software functions, features, internal
                                                control checks in compliance with IFRS 16.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>--}}
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="box s_bg_1">
                        ...
                        <p>Create your account and benefit immediately of Leasing Software. Easy to Use, you will take
                            in hand with full autonomy.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="box s_bg_2">
                        ...
                        <h2>Affordable</h2>
                        <p>The subscription offers of Leasing Software are attractive and affordable to all sizes of
                            companies. You have a trial period to test our software.</p>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    <div class="box s_bg_3">
                        ...
                        <h2>Innovative</h2>
                        <p>The Leasing Software offers innovative features to value your lease liabilities at present
                            value, get disclosures at reporting period and lock your lease period. Explore full features
                            of the software.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="box s_bg_4">
                        ...
                        <h2>Effective</h2>
                        <p>The Leasing Software offers a powerful set of features to speed up the valuation of your
                            company’s leases and stay compliant with New Lease Accounting Standard.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row clearfix">
                    <div class="col-md-4 col-sm-6">
                        <div class="single-profile-top wow fadeInDown animated">
                            ...
                            <p>Complete Your Settings in accordance with the all Predefined fields applicable as per
                                Lease Accounting Standard</p>
                        </div>
                    </div><!--/.col-lg-4 -->
                    ...
                    <div class="col-md-4 col-sm-6 col-md-offset-2">
                        <div class="single-profile-bottom wow fadeInUp animated">
                            ...
                            <ul>
                                ...
                                <li>Revalue Your Lease Subsequently for any change in Lease Details including Change in
                                    Discount Rates
                                </li>
    ...
    <section class="shortcode-item  new-sec"
             style="background: url({{ asset('master/images/track.jpeg') }}) no-repeat fixed;">
        <div class="container">
            <div class="row">
                        ...
                        <div class="media">
                            <div class="parrent pull-left">
                                <ul class="nav nav-tabs nav-stacked">
                                    <li class=""><a href="#tab1" data-toggle="tab" class="analistic-01">Lease Cash
                                            Flows</a></li>
                                    <li class=""><a href="#tab2" data-toggle="tab" class="analistic-02">Track Lease
                                            Balances</a></li>
                                    <li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Disclosures</a></li>
                                    <li class="active"><a href="#tab4" data-toggle="tab" class="tehnical">Reports</a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="tab1">
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <p class="animation anm_2">Timely Update Your Lease Cash Flows to Keep
                                                    Accurate Lease Valuation</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="tab3">
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <p class="animation anm_2">Get Completely Filled Lease Disclosures
                                                    Details for Every Audit Period with Lease Maturity Analysis</p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="media">
                                            <div class="media-body">
                                                ...
                                                <div class="col-md-7 animation anm_2">
                                                    <img src="{{ asset('master/images/dashboard.jpg') }}"
                                    ...
                                    <div class="tab-pane" id="tab5">
                                        <div class="media-body">
                                            ...
                                            <p class="animation anm_2">Reconcile Your Lease Balances on a Regular Basis
                                                with your Accounting Ledgers</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
